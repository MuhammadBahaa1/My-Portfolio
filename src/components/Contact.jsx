...
const socialLinks = [
  {
    href: 'https://github.com/MuhammadBahaa1/',
  ...
  {
    href: 'https://www.linkedin.com/in/muhammad-bahaa',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/muhammadbahaa1/',
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key)=> (
              ...
              transition-[background-color,colors] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
                {icon}
              </a>
            ))}
          </div>
        ...
        <form action="https://getform.io/f/bxoolrra" method="POST" className="xl:pl-10 2xl:pl-20">
            ...
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              <div className="mb-4">
                ...
                <input type="text" name="name" id="name" autoComplete="name" required placeholder="Mohammed Bahaa" className="text-field reveal-up" />
              </div>
              ...
              <div className="mb-4">
                ...
                <input type="email" name="email" id="email" autoComplete="email" required placeholder="mohammed@example.com" className="text-field reveal-up" />
              </div>
